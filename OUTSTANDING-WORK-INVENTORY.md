...
| # | Item |
|---|---|
| 45 | ~~Fix heading order on remaining pages~~ **COMPLETE 2026-09-19** - A-1 (20) + A-1.2 (73) + A-1.3 (24) = 117/165 templates fixed. Remaining ~48 excluded (admin/blog/tools/includes + shared layout). | DONE |
